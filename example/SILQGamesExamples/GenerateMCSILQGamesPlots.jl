...
convergence_plot = plot_convergence(all_convergence_metrics, all_num_iters, mc_max_iters, mc_threshold; lower_bound=mc_threshold/10)

# 2. Plot the convergence histogram. For the LQ case, all items should be in first bin.
convergence_histogram = plot_convergence_histogram(all_num_iters, num_buckets)
