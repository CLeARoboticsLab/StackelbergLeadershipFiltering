...
plot!(q1, title="", legend=:bottomleft, xaxis=[-2.5, 2.5], yaxis=[-2.5, 2.5], legendfontsize = 14)
filename = string("silq_lq_results_leader", leader_idx, "_3_position.pdf")
savefig(q1, filename)

plot!(q8, title="", xaxis=[-0.1, 1.1], xticks=[0, 1], legendfontsize = 14)
filename = string("silq_lq_results_leader", leader_idx, "_3_convergence.pdf")
savefig(q8, filename)

plot!(q9, title="", xaxis=[-0.1, 1.1], xticks=[0, 1], legendfontsize = 14)
